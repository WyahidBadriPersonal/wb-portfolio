  ...
  return (
    <nav className="fixed top-0 z-10 flex w-full items-center justify-between border-b
     border-b-gray-700 bg-black/70 px-16 py-6 text-white backdrop-blur-md md:justify-evenly">
        <a href="#home" className="bg-gradient-to-tr from-blue-500 to-pink-500 
        bg-clip-text text-transparent opacity-80 text-3xl font-semibold transition-all duration-300 hover:opacity-100">
            Wyahid Badri
        </a>
        ...
        <ul className="hidden md:flex gap-5">
            ...
            <a href="https://www.linkedin.com/in/wyahidbadri/" target="_blank"><BsLinkedin /></a>
            </li>
        </ul>
